...
test("live performance desk explains its measurement and the replay workflow", async ({ page }) => {
  await seedLivePortfolio(page.request, "live-performance-journey", "Live performance lesson");
