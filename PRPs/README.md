...
Current stage: Chapter 1 implemented. Chapters 2–17 remain planned. See the [Chapter 1 guide](../docs/chapters/01-learning-guide.md) and [progress ledger](../docs/progress.md).
