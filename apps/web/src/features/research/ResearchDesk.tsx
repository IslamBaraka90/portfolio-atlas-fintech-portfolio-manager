    ...
    <LearningShell active={7}>
      ...
      <section className="chapter-panel">
        ...
        <fieldset disabled={busy} className="valuation-fields">
          ...
          <button className="primary-button" disabled={!loader} onClick={loadCompany}>
      ...
      <section className="chapter-panel">
        ...
        <fieldset disabled={busy} className="valuation-fields">
              ...
              <div className="chapter-form">
                ...
                <label>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setCompanyRefs((r) => ({ ...r, [d.instrument.instrumentId]: e.target.value }))
                    }
                  >
          ...
          <button className="primary-button" disabled={!selected.length} onClick={calculate}>
          ...
          <div data-testid="research-result">
            ...
            {result.trends.map((t) => (
              <article key={t.instrumentId}>
                ...
                <p>
                  {t.status} · {t.basis} · Latest close: {t.latestRelation ?? "unavailable"} the SMA
                </p>
                <p>
                  Evidence known: {t.knownAt}. Initial warm-up: {t.warmupSlots} slots. Missing slots
                  restart the window.
                </p>
                {t.reasons.map((r) => (
                  <p className="warning-note" key={r}>
                    {r}
                  </p>
                ))}
                <p>
            ...
            <details>
              ...
              <p>
                {result.policyVersion} · fintech-algorithms {result.packageVersion} · Shared-fixture
                parity
              </p>
